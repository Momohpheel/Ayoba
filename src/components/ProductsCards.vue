   ...
   <div class="relative">
      ...
      <ul class="mt-10 gap-8 w-full lg:justify-center lg:mx-auto lg:gap-4">
          ...
          <li class="flex-shrink-0 min-w-[200px] max-w-[25%]">
            ...
            <div class="flex">
            <div class="w-full p-4 mx-1 bg-yellow-800 rounded-lg">
              ...
              <div class="w-full p-4 bg-yellow-800 rounded-lg">
...
<div class="flex">
<div class="w-full p-4 mx-1 bg-gray-900 rounded-lg">
  ...
  <div class="w-full p-4 bg-gray-900 rounded-lg">
      <p class="text-white text-sm">Manage Your Pet Insurance</p>
      <div class="flex justify-end mt-8">
