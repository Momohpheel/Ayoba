          ...
          <div class="lg:w-3/4 lg:mr-3">
            ...
            <div class="mt-4 lg:flex">
              ...
              <div class="lg:w-full lg:ml-3 mt-4 lg:mt-0">
                ...
                <div class="relative">
                    <select v-model="color_id" class="rounded block mt-4 bg-blue-100 px-4 py-2 w-full outline-none focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" required>
                        <option v-for="(type, index) in data.color" :key="index" :value="type.id">{{type.name}}</option>
                    </select>
                    <p v-if="color_id == ''" class="absolute text-gray-500" style="top: 8px; left: 8px">E.g Red</p>
                </div> 
              </div>
            </div>
            <div class="mt-4 lg:flex">
              ...
              <div class="lg:w-full lg:ml-3 mt-4 lg:mt-0">
                ...
                <div class="relative">
                    <select v-model="year_id" class="rounded block mt-4 bg-blue-100 px-4 py-2 w-full outline-none focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" required>
                        <option v-for="(type, index) in data.year" :key="index" :value="type.id">{{type.name}}</option>
                    </select>
                    <p v-if="year_id == ''" class="absolute text-gray-500" style="top: 8px; left: 8px">E.g 2013</p>
                </div>
              </div>
            </div>
            <!-- <div class="mt-4">
          ...
          <div class="mt-6">  
            <div class="mt-8 lg:flex justify-between">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <select v-model="idmeans_id" class="block rounded mt-4 bg-blue-100 px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" required>
                        ...
                        <option v-for="means in data.id_means" :key="means.id" :value="means.id">{{means.name}}</option>
                      </select>
              ...
              <div class="lg:ml-3">
                ...
                <div class="mt-4">
                  <label class="text-sm font-bold">License Issue Date</label>
 ...
 components: {
    ...
    methods:{
        ...
        getResources(){
          ...
          .then(res=>{
            this.$store.commit('setAiccoVehicleResources', res.data.data)
    ...
    computed:{
      ...mapState({
          ...
          data: state => state.vehicle.aiicoResources
      }),
    },
    mounted(){
