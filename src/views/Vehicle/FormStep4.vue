<template>
  <div class="mt-6 lg:pb-8">
    <div class="lg:w-3/4 lg:mx-auto">
      ...
      <p v-else-if="$store.state.vehicle_category_id == 3" class="mt-2">Prime Cover</p>
      <hr class="mt-4">
      ...
      <div class="py-8 md:py-12 md:flex md:w-3/4 md:justify-between">
        <div v-if="$store.state.vehicle_category_id == 1" class="md:mr-4">
      ...
      <div class="md:flex md:justify-between md:items-end">
        ...
        <router-link to="/app/dashboard/buyvehicle/3" >
...
export default {
  components:{
    Paystack, TermsModal, PaymentMethod
  },
  data(){
    return {
      paystackData: {
