  ...
  <div class="mt-10 lg:w-3/4 lg:mx-auto">
      ...
      <form @submit.prevent="submit" class="py-6 lg:pb-20" style="min-height: 30vh">
        ...
        <div class="lg:w-full lg:mr-3 mb-6">
          ...
          <div class="relative">
            <select v-model="payment_frequency_id" class="rounded block mt-4 bg-blue-100 px-4 py-2 w-full outline-none focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" required style=" background-color: #e2f5ec;">
